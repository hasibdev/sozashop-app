...
class ProfileModel {
  ...
  @override
  String toString() {
    return 'ProfileModel(id: $id, clientId: $clientId, firstName: $firstName, lastName: $lastName, designation: $designation, email: $email, emailVerifiedAt: $emailVerifiedAt, lastLogin: $lastLogin, mobile: $mobile, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, type: $type, name: $name, userLastLogin: $userLastLogin, availableRoles: $availableRoles, profilePhotoUrl: $profilePhotoUrl, roles: $roles, permissions: $permissions, media: $media)';
  }
}

...
class KPageRefreshDemo2 extends StatefulWidget {
  final Widget child;

  const KPageRefreshDemo2({
    Key? key,
    required this.child,
  }) : super(key: key);

  @override
  _KPageRefreshDemo2State createState() => _KPageRefreshDemo2State();
}

class _KPageRefreshDemo2State extends State<KPageRefreshDemo2>
